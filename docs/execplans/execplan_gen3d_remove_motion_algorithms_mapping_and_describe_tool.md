...
- `describe_tool_v1` removed; tool-schema introspection uses `get_tool_detail_v1`.
...
- The Gen3D agent tool registry supports `get_tool_detail_v1` for targeted tool-schema introspection.
...
- Gen3D agent tooling: tool-schema introspection uses `get_tool_detail_v1`; `describe_tool_v1` is removed.
