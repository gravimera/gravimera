...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/fence_x";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "FenceX";
...
pub(crate) fn def() -> ObjectDef {
    let axis = FenceAxis::X;
    let size = Vec3::new(BUILD_FENCE_LENGTH, BUILD_FENCE_HEIGHT, BUILD_FENCE_WIDTH);
