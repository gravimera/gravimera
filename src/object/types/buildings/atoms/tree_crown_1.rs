...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_crown_1";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeCrown1";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                mesh: MeshKey::TreeCone,
                material: MaterialKey::TreeCrown { variant: 1 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
