...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_main_2";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeMain2";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeMain { variant: 2 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
