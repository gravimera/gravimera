...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_crown_2";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeCrown2";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeCrown { variant: 2 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
