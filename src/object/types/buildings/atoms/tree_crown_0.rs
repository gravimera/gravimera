...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_crown_0";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeCrown0";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeCrown { variant: 0 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
