...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_main_1";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeMain1";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeMain { variant: 1 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
