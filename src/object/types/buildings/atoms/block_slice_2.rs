...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/block_slice_2";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "BlockSlice2";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::BuildBlock { index: 2 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
