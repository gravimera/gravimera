...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_trunk_2";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeTrunk2";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                mesh: MeshKey::TreeTrunk,
                material: MaterialKey::TreeTrunk { variant: 2 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
