...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_trunk_1";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeTrunk1";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeTrunk { variant: 1 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
