...
pub(crate) const OBJECT_KEY: &str = "gravimera/builtin/buildings/atoms/tree_trunk_0";
#[allow(dead_code)]
pub(crate) const LABEL: &str = "TreeTrunk0";
    ...
    ObjectDef {
        ...
        parts: vec![ObjectPartDef::primitive(
            PrimitiveVisualDef::Mesh {
                ...
                material: MaterialKey::TreeTrunk { variant: 0 },
            },
            Transform::IDENTITY,
        )],
        minimap_color: None,
